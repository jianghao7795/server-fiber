...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/moblieUser/deleteMoblieUserByIds": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
